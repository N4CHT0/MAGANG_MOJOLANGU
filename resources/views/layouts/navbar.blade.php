    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="/home">
                ...
                <!-- Logo text --><span>
                    <!-- dark Logo text -->
                    <img src="{{ asset('admin-master/assets/images/logo-text.png') }}" alt="homepage"
                        class="dark-logo" />
                    <!-- Light Logo text -->
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#"
                        ...
                        <img src="{{ asset('admin-master/assets/images/users/1.jpg') }}" alt="user"
                            class="" />
                        <span class="hidden-md-down">{{ Auth::user()->nama_lengkap }} &nbsp;</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li>
                            <a class="dropdown-item" href="{{ route('logout') }}"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <i class="fa fa-close" style="margin-right: 10px; color: red"></i> Log Out
                            </a>
                        </li>
