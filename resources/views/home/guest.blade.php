...
@section('content')
    <div class="hero-slider">
        <div class="slider-item th-fullpage hero-area"
            style="background-image: {{ asset('landing-master/theme/images/slider/slider-bg-1.jpg') }};">
            <div class="container">
                <div class="row">
        ...
        <div class="slider-item th-fullpage hero-area"
            style="background-image: {{ asset('landing-master/theme/images/slider/slider-bg-2.jpg') }};">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center d-none d-md-block">
                    <img loading="lazy" src="{{ asset('landing-master/theme/images/about/member.jpg') }}"
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img loading="lazy" src="{{ asset('landing-master/theme/images/about/about-2.png') }}" class="img-fluid"
                        alt="">
                </div>
                <div class="col-md-6">
                    <ul class="checklist">
                    ...
                    <div class="testimonial-slider">
                        ...
                        <div class="item text-center">
                            ...
                            <div class="client-thumb">
                                <img loading="lazy"
                                    src="{{ asset('landing-master/theme/images/client-logo/clients-1.jpg') }}"
                                    class="img-fluid" alt="">
                            </div>
                        ...
                        <div class="item text-center">
                            ...
                            <div class="client-thumb">
                                <img loading="lazy"
                                    src="{{ asset('landing-master/theme/images/client-logo/clients-2.jpg') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="client-meta">
                                <h3>Emma Harrison</h3>
                        ...
                        <div class="item text-center">
                            ...
                            <div class="client-thumb">
                                <img loading="lazy"
                                    src="{{ asset('landing-master/theme/images/client-logo/clients-3.jpg') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="client-meta">
        ...
        <div class="container">
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="title text-center ">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus facere accusamus,
                            reprehenderit libero inventore nam.</p>
                    </div>
                </div>
                <!-- /section title -->
            </div>
            ...
            <div class="row">
                ...
                <article class="col-lg-4 col-md-6">
                    <div class="post-item">
                        <div class="media-wrapper">
                            <img loading="lazy" src="{{ asset('landing-master/theme/images/blog/post-1.jpg') }}"
                ...
                <article class="col-lg-4 col-md-6">
                    <div class="post-item">
                        <div class="media-wrapper">
                            <img loading="lazy" src="{{ asset('landing-master/theme/images/blog/post-2.jpg') }}"
                                alt="amazing caves coverimage" class="img-fluid">
                        </div>
                ...
                <article class="col-lg-4 col-md-6">
                    <div class="post-item">
                        <div class="media-wrapper">
                            <img loading="lazy" src="{{ asset('landing-master/theme/images/blog/post-3.jpg') }}"
                                alt="amazing caves coverimage" class="img-fluid">
                        </div>
