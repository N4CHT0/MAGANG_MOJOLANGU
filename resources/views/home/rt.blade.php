        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-md-4 mb-3">
                    <a href="{{ route('pembangunan.create') }}" class="card-link">
                        <div class="card h-100 position-relative">
                            <img src="{{ asset('admin-master/assets/images/pembangunan.jpg') }}" class="card-img-top"
                                alt="" style="max-height: 200px; object-fit: cover;">
                            <!-- Tambahkan div untuk teks hover -->
