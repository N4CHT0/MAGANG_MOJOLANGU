    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card">
                        <div class="card-header bg-info text-white">{{ __('Selamat Datang Warga Kelurahan Mojolangu') }}
                        </div>
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6>3. Jika Sudah Mendapat ID Telegram, Harap Masukan ID Telegram Anda <a
                                    href="#">Disini</a>
                            </h6>
